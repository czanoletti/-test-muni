...
let routeString = 'departamentos';


departamento.get(`/${routeString}`, function(req, res, next) {
...
/* parameters */
departamento.get(`/${routeString}/:id`, function(req, res, next) {
...
departamento.post(`/${routeString}`, (req, res)=>{
...
departamento.put(`/${routeString}/:id`, (req, res)=>{
  console.log(req.body);
  const {title, news} = req.body;
...
/* parameters */
departamento.delete(`/${routeString}/:id`, function(req, res, next) {
  console.log(req.params);
  console.log(req.params.id);
  connection.query({

...
var rolRoute = express.Router();
let connection = require('../config/db');
let routeString = 'rol';


rolRoute.get(`/${routeString}`, function(req, res, next) {
...
/* parameters */
rolRoute.get(`/${routeString}/:id`, function(req, res, next) {
...
rolRoute.post(`/${routeString}`, (req, res)=>{
...
rolRoute.put(`/${routeString}/:id`, (req, res)=>{
  console.log(req.body);
  const {title, news} = req.body;
...
/* parameters */
rolRoute.delete(`/${routeString}/:id`, function(req, res, next) {
  console.log(req.params);
  console.log(req.params.id);
  connection.query({

...
let routeString = 'usuario';


usuarioRoute.get(`/${routeString}`, function(req, res, next) {
...
/* parameters */
usuarioRoute.get(`/${routeString}/:id`, function(req, res, next) {
...
usuarioRoute.post(`/${routeString}`, (req, res)=>{
...
usuarioRoute.put(`/${routeString}/:id`, (req, res)=>{
  console.log(req.body);
  const {title, news} = req.body;
...
/* parameters */
usuarioRoute.delete(`/${routeString}/:id`, function(req, res, next) {
  console.log(req.params);
  console.log(req.params.id);
  connection.query({
